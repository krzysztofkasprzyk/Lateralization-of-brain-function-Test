...
psychoJS.event._keyDownHandler = function(e) {
	...
	psychoJS._keyBuffer.push({
		...
		key : e.key,
		keyCode: e.keyCode,
		timestamp : (typeof e.timeStamp === "number" && isFinite(e.timeStamp) ? e.timeStamp / 1000 : psychoJS.core.getTime())
	});
...
psychoJS.event._onMouseDown = function(ev) {
	...
	var x = ev.offsetX;
	var y = ev.offsetY;
	if (psychoJS.logging && typeof psychoJS.logging.data === "function") {
